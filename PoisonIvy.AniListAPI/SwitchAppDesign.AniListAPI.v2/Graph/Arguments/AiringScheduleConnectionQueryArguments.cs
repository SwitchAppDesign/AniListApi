...
namespace SwitchAppDesign.AniListAPI.v2.Graph.Arguments
{
    ...
    public class AiringScheduleConnectionQueryArguments
    {
        ...
        {
            NotYetAired = new GraphQueryArgument<bool>("notYetAired", GetType(), queryType, new QueryArgumentRules(false, null, null, new List<AniListQueryType> { AniListQueryType.Media }));
