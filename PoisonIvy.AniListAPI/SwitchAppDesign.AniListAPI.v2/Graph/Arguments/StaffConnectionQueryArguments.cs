...
namespace SwitchAppDesign.AniListAPI.v2.Graph.Arguments
{
    ...
    public class StaffConnectionQueryArguments
    {
        ...
        {
            Sort = new GraphQueryArgument<IEnumerable<StaffSort>>("sort", GetType(), queryType, new QueryArgumentRules(false, null, null, new List<AniListQueryType> { AniListQueryType.Media, AniListQueryType.Page }));
